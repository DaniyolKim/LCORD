...
const defs = {
  ...
  tierList: [ { text: 'AMOEBA', value: 1}, { text: 'ANIMAL', value: 2}, { text: 'HUMAN', value: 3}, { text: 'GOD', value: 4} ],
  ...
  tribes: [ {text: 'TERRAN', value: 'terran'}, {text: 'ZERG', value: 'zerg'}, {text: 'PROTOSS', value: 'protoss'}, {text: 'RANDOM', value: 'random'} ],
